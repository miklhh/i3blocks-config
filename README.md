...
```
You could also modify the font and font size in this file. The default *pango:monospace* will do just fine but you might want to increese the font size based on your needs.
```
